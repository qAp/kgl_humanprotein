# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/06_networks.densenet.ipynb (unless otherwise specified).

__all__ = ['DensenetClass', 'class_densenet121_dropout', 'class_densenet121_large_dropout']
