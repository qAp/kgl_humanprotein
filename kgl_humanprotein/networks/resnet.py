# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/06_networks.resnet.ipynb (unless otherwise specified).

__all__ = ['ResnetClass', 'class_resnet34_dropout', 'class_resnet18_dropout']
