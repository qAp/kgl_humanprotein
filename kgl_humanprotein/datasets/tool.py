# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/03_datasets.tool.ipynb (unless otherwise specified).

__all__ = ['tensor_to_image', 'tensor_to_label', 'image_to_tensor', 'label_to_tensor', 'opj']
