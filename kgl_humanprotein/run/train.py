...
__all__ = ['loss_names', 'split_names', 'main', 'train', 'validate', 'save_model', 'multi_class_acc', 'AverageMeter']
...
def main(out_dir, gpu_id='0', arch='class_densenet121_dropout',
    ...
    model_out_dir = opj(RESULT_DIR, 'models', out_dir, 'fold%d' % fold)
    ...
    train_split_file = (DATA_DIR/'split'/split_name/
