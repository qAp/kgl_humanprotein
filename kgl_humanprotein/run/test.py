...
__all__ = ['dummy_predict_image', 'write_dummy_submission', 'generate_crops', 'datasets_names', 'split_names',
           'augment_list', 'test', 'predict', 'prob_to_result', 'organise_results', 'write_submission_csv']
